                            ...
                            <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    <label for="nombre_curso" class="inline-block text-lg mb-2">
                                        <span class="font-bold">Nombre de la capacitación:</span> {{ $listing->nombre }}
                                    </label>
                                ...
                                <h2 class="text-lg">
                                    <p><span class="font-bold">Modalidad a realizar:</span> {{ $listing->modalidad }}
                                    </p>
                                    ...
                                    <p><span class="font-bold">Horas teóricas:</span> {{ $listing->horas_teoricas }}
                                    </p>


                                    <p><span class="font-bold">Horas prácticas:</span> {{ $listing->horas_practicas }}
                                    </p>
                                    ...
                                    <p><span class="font-bold">Porcentaje de asistencia requerido para acreditar curso
                                            del 70 al
                                    ...
                                    <p><span class="font-bold">Requiere evaluación de la capacitación adquidida (antes
                                            de los 30 días
                                ...
                                <input type="text" hidden="true" contenteditable="false"
                                    class="border border-gray-200 rounded p-2 w-full" name="tipo" rows="10"
                                    value="Asistente" </input>
                                ...
                                @else
                                    <a href="/" class="bg-laravel text-white rounded py-2 px-4 hover:bg-black">
                                        Volver
                                    </a href>
                            </div>
                            @endif
