          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ">
                ...
                @if (auth()->user()->es_admin == '1')
                    ...
                    <li>
                        <span class=" md:text-2xl block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-laravel md:p-0 hover:scale-125">
                            <i class="fa-sharp fa-solid fa-lock"></i> ADMIN
                        </span>
                    </li>
                    <li>
                        <a href="/bitacora" class="md:text-2xl hover:text-laravel">
                        <span class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-laravel md:p-0 hover:scale-125">
                ...
                @else
                    ...
                    <li>
                        <span class=" md:text-2xl block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-laravel md:p-0  hover:text-laravel">
