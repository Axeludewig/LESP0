    ...
    @if (auth()->check() && $listing->tipo == 'Presencial' && auth()->user()->es_admin=='0')
        ...
        <form method="POST" action="/listings">
            <div class="text-lg mt-4 flex place-content-center">
                @csrf
                <button  data-modal-target="popup-modal{{ $listing->id }}" data-modal-toggle="popup-modal{{ $listing->id }}" type="button" class="text-black hover:text-white bg-mich4 border-2 border-laravel from-laravel to-mich4 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium    rounded-lg text-xl px-5 py-2.5 text-center mr-2 mb-2 w-[215px]"><div class="flex items-center justify-center"><i class="fa-regular fa-hand-point-down"></i>&nbsp;Click para Registro&nbsp;<i class="fa-regular fa-hand-point-down"></i></div></button>
            </div>
                ...
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400"><div class="flex flex-col text-center items-center justify-center dark:text-white"><p>Confirma tu registro.</p><p>CURSO: {{$listing->nombre}}</p></div></h3>
    ...
    @if (auth()->check() && $listing->tipo == 'Actividad' && auth()->user()->es_admin=='0')
        ...
        <div class="flex place-content-center mt-6">
                ...
                <a href="/users/actividades/{{ $listing->id }}"
                    ...
                    <div class="flex items-center justify-center"><i class="fa-regular fa-hand-point-down"></i>&nbsp;Click para ir a la actividad&nbsp;<i class="fa-regular fa-hand-point-down"></i></div></a>
        </div>
        @endif
        @if ($validado !== null)
        <div class="flex place-content-center mt-6">
    ...
    @if (auth()->check() && $listing->tipo == 'Virtual' && auth()->user()->es_admin=='0')
        ...
        <div class="flex place-content-center mt-6">
                <a href="/users/xevalz/{{$listing->id}}"
                    class="text-black hover:text-white bg-mich4 border-2 border-laravel from-laravel to-mich4 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium    rounded-lg text-xl px-5 py-2.5 text-center mr-2 mb-2 w-[215px] "><div class="flex items-center justify-center"><i class="fa-regular fa-hand-point-down"></i>&nbsp;Click para ir a la evaluación&nbsp;<i class="fa-regular fa-hand-point-down"></i></div></a>
        </div>
        @endif
    @endif
</x-card>
