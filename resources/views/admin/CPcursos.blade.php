    ...
    <div class="flex flex-col md:flex-row items-center justify-center gap-4 mx-6">
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg    hover:scale-105 shadow-xl w-full">
            <a href="/listings/create">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Nuevo Curso</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 ">Agregar curso presencial o en línea.</p>
            <a href="/listings/create" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-laravel rounded-lg hover:bg-mich4  hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300  ">
                Agregar
