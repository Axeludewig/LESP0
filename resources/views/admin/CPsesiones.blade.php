<x-layout>
    <a href="/admin/paneldecursos" class="inline-block text-black ml-4 mb-4"><i class="fa-solid fa-arrow-left"></i> Volver </a>
    ...
    <div class="m-6 flex bg-gray-50 border border-gray-200 rounded p-6 place-content-center mb-24">
        <h3 class="text-2xl">
