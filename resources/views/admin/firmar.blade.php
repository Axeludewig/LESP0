<x-layout>
    ...
    <div class="flex flex-col justify-center items-center border shadow rounded-lg p-4">
        ...
        <form method="post" action="/admin/firmar">
            @csrf
            <div class="flex gap-4 items-center m-4">
                
                <label for="otp">Código de confirmación:</label>
                <input type="text" name="otp" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
            </div>
