@php
    $evaluador = DB::table('users')
        ->where('id', $eval->id_evaluador)
        ->first();
@endphp

<x-layout>
    <a href="/admin/evaladq/{{ $eval->id_evaladq }}" class="inline-block text-black ml-4 mb-4"><i
    ...
    <div class="border rounded-lg shadow p-4">
        <div class="text-center">
            ...
            <div class="text-center md:border md:shadow rounded-lg m-2 mx-24 p-4 flex flex-col gap-6">
                ...
                <div class="flex gap-24 justify-center  items-center">
                    <div class="w-[300px]">
                        <label for="evaluacion4">Utilidad de la capacitación adquirida para la realización de su
                            trabajo</label>
                    </div>
                ...
                <div class="text-center">
                    <p><span class="font-semibold">Malo</span> de 1 a 8, <span class="font-semibold">Deficiente</span>
                        de 9 a 16, <span class="font-semibold">Regular</span> de 17 a 24, <span
                            class="font-semibold">Bueno</span> de 25 a 32, <span class="font-semibold">Muy bueno</span>
                        de 33 a 40</p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex justify-center items-center gap-4">
                    <label for="necesidad_capacitacion">¿Usted ha detectado en el personal evaluado alguna necesidad de
                        capacitación?</label>
                    <p>{{ $eval->necesidad_capacitacion }}</p>
                </div>
                <label for="descripcion_necesidad">De responder si en la pregunta anterior describa cual es la
                    necesidad:</label>
                <p>{{ $eval->descripcion_necesidad }}</p>
                <div class="flex justify-center items-center gap-4">
                    <label for="calificacion">Calificación obtenida en la evaluación /examen del curso (cuando
                        aplique):</label>
