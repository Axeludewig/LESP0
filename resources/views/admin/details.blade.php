        ...
        <x-card>
            <div class="flex justify-center">
                ...
                <div>
                        ...
                        <div class="m-4">
                            <div>
                                <span class="font-semibold cursor-pointer"
                                    onclick="toggleList({{ $listing->id }})">Participantes: {{ $cuenta }}</span>
                                @if ($cuenta > 0)
                                    <button
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <form action="/admin/adduser" method="POST" id="form">
                                                    ...
                                                    <button id="add-participant-btn"
                                                        class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2 mb-6 mt-6">
                                                        Agregar usuario
                                                    </button>
                                                    ...
                                                    <h3
                                                        class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 mt-6">
                                                        ¿Estás seguro que deseas agregar el/los participante(s)?</h3>
                                                    <button data-modal-hide="popup-modal1" type="submit"
                                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2 mb-4"
                                                        id="submitter">
                                                        Sí, estoy seguro
                                                    </button>
                                                </form>
                                ...
                                <div class="max-h-[525px] w-[750px] overflow-y-auto hidden p-2 "
                                    id="participantesList{{ $listing->id }}">
                                    <ul>
                                        <div class="">
                                            @php $num = 1; @endphp
                                            @foreach ($participantes as $participante)
                                                <li>{{ $num . ' - ' }}{{ $participante->nombre_participante }} &nbsp;
                                                    <form method="POST"
                                                        action="/admin/destroyparticipante/{{ $participante->id }}">
                                                        <div class="mb-2">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button data-modal-target="popup-modal2"
                                                                data-modal-toggle="popup-modal2" type="button"
                                                                class="text-red-500"><i class="fa-solid fa-trash"></i>
                                                                Eliminar</button>
                                                        </div>
                    ...
                    <div class="flex justify-center m-2 shadow border rounded-lg p-2">
                        <form method="POST" action="/admin/importar_participantes/{{ $listing->id }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="file" />
                            <button class="px-4 py-2 shadow border rounded-lg text-white bg-laravel">
                    ...
                    @if (auth()->user()->es_admin == '1' && $listing->status == 'En proceso')
                        <form method="POST" action="/listingsfinal/{{ $listing->id }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            {{ csrf_field() }}
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full"
                                name="nombre_curso" hidden="true" value="{{ $listing->nombre }}" />
                            ...
                            <div class=" mb-4 text-lg mt-4 flex place-content-center">
                                ...
                                <button data-modal-target="popup-modal4" data-modal-toggle="popup-modal4"
                                    type="button" class="bg-laravel text-white rounded py-2 px-4 hover:bg-black">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                ¿Estás seguro que deseas finalizar el curso? Los participantes podrán
                                                descargar constancias. No hay vuelta atrás para esta acción.</h3>
                                            <button data-modal-hide="popup-modal4" type="submit"
                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                Sí, estoy seguro
                                            </button>
                                            <button data-modal-hide="popup-modal4" type="button"
                                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                                cancelar</button>
                                        </div>
                                    </div>
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                ¿Estás seguro que deseas iniciar el curso? Nadie más podrá registrarse.
                                            </h3>
                    ...
                    <form method="POST" action="/listings/{{ $listing->id }}">
                        <div class="text-lg mt-4 flex place-content-center">
                            @csrf
                            @method('DELETE')
                            <button data-modal-target="popup-modal5" data-modal-toggle="popup-modal5" type="button"
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Estás
                                            seguro que deseas eliminar el curso?</h3>
                                        <button data-modal-hide="popup-modal5" type="submit"
                                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            Sí, estoy seguro
                                        </button>
                                        <button data-modal-hide="popup-modal5" type="button"
                                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                                            cancelar</button>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            $('#add-participant-btn').click(function(e) {
                ...
                var removeButton = $('<button></button>')
                    .text('Remove')
                    .addClass(
                        'remove-button text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2'
                    )
                    .click(function() {
                        userElement.remove();
                    });
