        ...
        <div>
            ...
            <section class="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                    <a href="/" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-black bg-green-100 rounded-full dark:bg-mich4">
                        <span class="text-xs bg-mich4 rounded-full text-black px-4 py-1.5 mr-3">Volver</span> <span class="text-sm font-medium">Ir a la página principal.</span> 
                    ...
                    <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">No tienes autorización para estar en esta página. Se notificará al administrador de este incidente.</h1>
                    <div class="mt-16 animate-bounce mb-44 text-red-600 text-4xl">
                        ACCESO RESTRINGIDO
                    </div>
