...
<x-layout>
    ...
    <div class="flex flex-col md:flex-row items-center justify-center gap-4 mx-6">
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg  hover:scale-105 shadow-xl w-full md:my-4">
            <a href="/users/xevalz/{{$evals->id}}" alt="holo">
              <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 truncate">{{$evals->nombre}}</h5>
            </a>
            
            <a href="/users/xevalz/{{$evals->id}}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-laravel rounded-lg hover:bg-mich4 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 ">
              Ir a Evaluación
