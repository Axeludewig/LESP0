    ...
    <style>
        * {
        ...
        .grid-container {
            ...
            /* Change to center instead of start */
        }
...
<body>
    ...
    <h3>LABORATORIO ESTATAL DE SALUD PÚBLICA</h3>
        ...
        <div class="grid-container">
            <table style="width: 100%; margin-bottom: 8px;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="grid-item">
                            ...
                            {{ date('Y-m-d h:i A', strtotime($curso->fecha_de_terminacion)) }}
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <div class="grid-item">
                            <span>Porcentaje de asistencia requerido para acreditar el curso:</span>
                            {{ $curso->porcentaje_asistencia }}
                        </div>
                    </td>
                    <td>
                        <div class="grid-item">
                            <span>Calificación requerida para acreditar el curso:</span>
                            {{ $curso->calificacion_requerida }}
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div class="grid-item">
                            <span>Requiere evaluación de la capacitación adquirida (antes de los 30 días
                                hábiles):</span> {{ $curso->evaluacion_adquirida }}
                        </div>
                    </td>
                </tr>
        </div>
