<section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
  ...
  <div class="z-10">
    <h1 class="text-6xl font-bold uppercase text-white">
      LESP<span class="text-black">MICH</span>
    </h1>
    ...
    <div>
      ...
      @else
      <a href="/register"
        class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">Crea una cuenta</a>
      @endauth
    </div>
  </div>
</section>
